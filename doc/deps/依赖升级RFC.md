...
**定位：**本文是**决策与排期**文档，归属需求编号 **OPT-P2-11**（依赖升级）。不替代 [详细技术方案](../arch/详细技术方案.html) 的功能规格，也不在本 RFC 合并时自动修改 `requirements.txt`。实施每一 Tier / Phase 须单独确认设计、`RELEASE_NOTES` 与回归清单。编号读法见 [需求编号与缩写规范](../需求编号与缩写规范.html)。  
...
大批量改写建议单模块验收后再更文档。详 [P0 验收手册](../qa/P0测试用例与验收手册.html) §优化交付验收。
...
RBAC v2 详设见 [RBAC 架构设计方案](../design/RBAC架构设计方案.html)。本节专门回答：**做 RBAC 前必须升哪些依赖？升级与 RBAC 如何排期？**
...
在**不升级 Flask 主版本**前提下，RBAC 发布除 [RBAC 详设 §验收](../design/RBAC架构设计方案.html) 外，还须满足：
...
- [RBAC 架构设计方案 v2](../design/RBAC架构设计方案.html) — OPT-P2-10 权威详设
- [详细技术方案 §15 风险与演进路线](../arch/详细技术方案.html#t15)
- [技术方案与前端设计](../design/技术方案与前端设计.html) — P0 依赖升级意向
- [非 Docker 部署指南](../ops/非Docker部署指南.html) — Python 3.8–3.11 与 gevent 故障
- [P0 测试用例与验收手册](../qa/P0测试用例与验收手册.html)
- [License Audit](../qa/LICENSE-AUDIT.html)
