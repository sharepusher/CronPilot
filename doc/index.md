...
> HTTP 定时回调调度台 · 每份文档提供 **HTML**（推荐浏览器阅读）与 **Markdown**（GitHub / IDE / 全文检索）两种格式。

## 文档列表

> **交付状态总览（推荐先看）：** [交付状态与路线图.html](交付状态与路线图.html) · [交付状态与路线图.md](交付状态与路线图.md) — 已发布版本 vs 待确认/未开始优化。

| 文档 | HTML | Markdown |
|------|------|----------|
| **交付状态与路线图（v1.2.0）** | [交付状态与路线图.html](交付状态与路线图.html) | [交付状态与路线图.md](交付状态与路线图.md) |
...
| Release Notes **v1.2.0** | [RELEASE_NOTES.html](RELEASE_NOTES.html) | [RELEASE_NOTES.md](../RELEASE_NOTES.md) · [doc/RELEASE_NOTES.md](RELEASE_NOTES.md) |
...
- HTML：`http://<主机>:5860/docs/` 或 `/docs/index.html`
- Markdown：`http://<主机>:5860/docs/index.md` 及各 `.md` 文件（浏览器或下载）
