...
case "$cmd" in
  ...
  test)
    ...
    "$CRONPILOT_VENV/bin/python" -m unittest tests.test_p0_phase_a tests.test_cronpilot_sign tests.test_job_log_display tests.test_job_log_outcome tests.test_job_log_id tests.test_job_health tests.test_job_log_outcome_filter tests.test_check_conf_production tests.test_ensure_business_tables tests.test_rbac_phase tests.test_rbac_scope tests.test_ajax_form_guard tests.test_operation_log tests.test_cron_edit_status tests.test_cron_schedule_display tests.test_cron_run_now tests.test_scheduler_db -v
    ;;
  check)
