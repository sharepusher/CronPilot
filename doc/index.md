...
| 文档 | HTML | Markdown |
|------|------|----------|
| **交付状态与路线图（v0.2.0）** | [交付状态与路线图.html](交付状态与路线图.html) | [交付状态与路线图.md](交付状态与路线图.md) |
...
| **任务生命周期与无删除**（含 LIFECYCLE-2：下线原因/备注必填/时间戳 · 设计已确认） | [任务生命周期与无删除设计.html](任务生命周期与无删除设计.html) | [任务生命周期与无删除设计.md](任务生命周期与无删除设计.md) |
